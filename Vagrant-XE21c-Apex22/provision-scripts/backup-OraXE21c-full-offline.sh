...
# --------------------------------------------------------------------------------
# Purpose:
#   Offline backup of Oracle XE database to ./guest-backups mounted as /backups directory.
# Requirements:
#   Must have a consistant outage window. Preferably only once a week and not in USA or UK peak hours.
# History:
